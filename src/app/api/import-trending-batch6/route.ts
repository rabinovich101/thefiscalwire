...
const ARTICLES: ArticleInput[] = [
  ...
  },
  {
    ...
    readTime: 6,
    relevantTickers: ['SPY', 'TLT', 'GLD', 'XLE', 'TIP'],
  ...
  },
  {
    ...
    readTime: 6,
    relevantTickers: ['LMT', 'NOC', 'RTX', 'GD', 'BA'],
...
export async function GET(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({
      success: true,
      message: 'Trending articles import complete - March 27 Batch 6 (Late Evening)',
      results,
