...
export async function GET(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({
      success: true,
      message: 'Trending articles import complete - March 27 Batch 5 (Evening)',
      results,
