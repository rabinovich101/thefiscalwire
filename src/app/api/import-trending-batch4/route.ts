...
const ARTICLES: ArticleInput[] = [
  ...
  },
  {
    ...
    excerpt: 'The landmark CLARITY Act, which would establish a comprehensive regulatory framework defining which digital assets are commodities versus securities, faces a critical congressional deadline today with over 90% approval odds according to prediction markets.',
    content: [
...
export async function GET(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({
      success: true,
      message: 'Trending articles import complete - March 27 Batch 4 (Afternoon)',
      results,
