...
export default async function MarketsPage() {
  const [articles, totalCount, trendingStories] = await Promise.all([
    getArticlesByCategory("us-markets", PAGE_SIZE),
    getArticleCountByCategory("us-markets"),
        ...
        <section className="bg-gradient-to-b from-blue-600/10 to-transparent py-12">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl">
              Stay informed with the latest stock market news, trading insights, and comprehensive market analysis.
            </p>
          </div>
        </section>
