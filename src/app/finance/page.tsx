...
export const metadata: Metadata = {
  title: "Finance | The Fiscal Wire",
  description: "Financial services, banking, corporate finance news and analysis.",
};
...
export default async function FinancePage() {
  const [articleData, trendingStories, pageContent] = await Promise.all([
    getCategoryArticlesWithPlacements("finance", PAGE_SIZE, 0),
    getTrendingStories(8),
    getCategoryPageContent("finance"),
  ]);
        ...
        <section className="bg-gradient-to-b from-blue-600/10 to-transparent py-12">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl">
              Financial services, banking industry news, corporate finance, and investment insights.
            </p>
          </div>
        </section>
