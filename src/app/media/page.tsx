...
export const metadata: Metadata = {
  title: "Media | The Fiscal Wire",
  description: "Media industry news, entertainment, streaming platforms, and broadcasting updates.",
};
...
export default async function MediaPage() {
  const [articles, totalCount, trendingStories] = await Promise.all([
    getArticlesByCategory("media", PAGE_SIZE),
    getArticleCountByCategory("media"),
        ...
        <section className="bg-gradient-to-b from-purple-600/10 to-transparent py-12">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl">
              Media industry news, entertainment business, streaming platforms, and broadcasting updates.
            </p>
          </div>
        </section>
