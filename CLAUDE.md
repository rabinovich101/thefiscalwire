1. Think and Plan: First, slow down and think through the entire problem. Read the codebase for relevant files and write a detailed plan to a todo.md file.
2. Create a Checklist: The plan must contain a list of to-do items that can be checked off as they are completed.
3. Verify the Plan: Before starting work, check in with the user to verify and approve the plan.
4. Execute Step-by-Step: Begin working on the to-do items, marking them as complete as you go.
5. Explain Changes: At every step, provide a high-level explanation of the changes being made.
6. Keep it Simple: Make every task and code change as simple as humanly possible. Avoid massive or complex changes; touch as little code as possible.
