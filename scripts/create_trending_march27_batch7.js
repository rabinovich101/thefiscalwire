...
// 5 Trending Viral Articles - March 27, 2026 (Batch 7 - Late Night Edition)
const articles = [
  {
  ...
  },
  {
    ...
    business: 'finance',
    isBreaking: false,
    tags: ['Goldman Sachs', 'Morgan Stanley', 'M&A', 'investment banking', 'Wall Street']
  },
  {
...
async function main() {
  console.log('=== Creating 5 Trending Articles - March 27, 2026 (Batch 7 - Late Night) ===\n');
