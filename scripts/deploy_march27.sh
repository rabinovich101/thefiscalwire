#!/bin/bash
# Deployment script for 5 trending financial articles - March 27, 2026
# Run this ON THE PRODUCTION SERVER after SSH'ing in

echo "Deploying 5 Trending Articles - March 27, 2026..."
echo ""
...
docker cp /tmp/create_trending_march27.js $CONTAINER:/app/scripts/
docker cp /tmp/add_to_zones.js $CONTAINER:/app/scripts/

echo ""
echo "Step 1: Creating 5 trending articles in production database..."
docker exec $CONTAINER node scripts/create_trending_march27.js
